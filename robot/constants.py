...
CONFIG_PATH = os.path.expanduser(os.getenv("JOI_CONFIG", "~/.joi"))
CONTRIB_PATH = os.path.expanduser(os.getenv("JOI_CONFIG", "~/.joi/contrib"))
CUSTOM_PATH = os.path.expanduser(os.getenv("JOI_CONFIG", "~/.joi/custom"))
